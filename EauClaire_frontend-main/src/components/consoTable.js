        ...
        <div className="conso-table-container">
                ...
                <select
                    ...
                    onChange={(e) => {
                        ...
                        document.querySelectorAll('.conso-table td').forEach(cell => {
                            cell.classList.remove('surconsommation-oui', 'surconsommation-non');
                        });
                    }}
                >
                    ...
                    <tbody>
                        {data.map((region, index) => (
                            <tr key={index}>
                                ...
                                <td className={getSurconsommationClass(region["Surconsommation (Oui/Non)"])}>
            ...
            <div className="alert-section">
                ...
                <select value={region} onChange={(e) => setRegion(e.target.value)}>
                    ...
                    {data.map((region, index) => (
                        <option key={index} value={region.Région}>{region.Région}</option>
                    ))}
                </select>
